...
- 修复 Windows 上 `sideaudio doctor` / `setup` 与桌面版设置页在后台命令位于含空格目录
...
- 修复 `sideaudio install --help`、`skill --help`、`config set --help` 与
...
- 修复 Windows 上 `sideaudio skill` 各子命令与 Gateway 启动时的技能补装因直接启动
