...
const INTERNAL_NAMES = new Set([
  'SIDE_AUDIO_BOT_BACKEND_AGENT',
  'SIDE_AUDIO_BOT_BACKEND_MODEL',
  'SIDE_AUDIO_BOT_BACKEND_OWNERSHIP',
  'SIDE_AUDIO_BOT_BACKEND_PERMISSION_MODE',
  'SIDE_AUDIO_BOT_DESKTOP',
  'SIDE_AUDIO_BOT_DESKTOP_INSTALLED_ONLY',
  'SIDE_AUDIO_BOT_ENV_LOADED',
  'SIDE_AUDIO_BOT_NODE',
  'SIDE_AUDIO_BOT_ROOT',
  'SIDE_AUDIO_BOT_RUNTIME_ROOT',
  'SIDE_AUDIO_BOT_SOURCE_ROOT',
])
